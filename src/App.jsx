...
function Boot({ reduced }) {
  ...
  useEffect(() => {
    const id = setTimeout(() => setDone(true), reduced ? 120 : 1450)
  ...
  return (
    <div className={`boot ${done ? 'is-done' : ''}`} aria-hidden="true">
      ...
      <div className="boot-stack">
        ...
        <b>ENGINEERING SIGNAL</b>
        <div className="boot-track"><i /></div>
        <small>ALMATY · 43.2380°N / 76.9455°E</small>
      </div>
    </div>
  )
}
  ...
  return (
    <section className="manifesto paper" id="manifesto">
      ...
      <h2 className="manifesto-title">
        ...
        <span><em>IS HOW</em> WE</span>
        <span>MAKE PRESSURE</span>
        <span>USEFUL.</span>
      </h2>
      <div className="manifesto-foot">
        <p>ABAI BOL is a competition robotics team from Almaty. We prototype, code, test, fail, rebuild and document the delta — because a machine only becomes reliable after the idea survives pressure.</p>
        <div><strong>43.2380° N</strong><strong>76.9455° E</strong><span>HOME BASE / ALMATY</span></div>
      </div>
    </section>
  )
}
    ...
    <section className="identity-v2 dark" id="identity">
      ...
      <div className="identity-v2-inner">
        ...
        <div className="identity-words">
          <div className="identity-old">ANTARES</div>
          <div className="identity-arrow">→</div>
          <div className="identity-new">ABAI BOL</div>
        </div>
        <div className="identity-statement">
          <h2>THE NAME<br/>CHANGED.<br/><em>THE TEAM DIDN'T.</em></h2>
          <p>The ANTARES competition history stays visible because it belongs to the same team journey. ABAI BOL is not a reset — it is the next build.</p>
        </div>
      </div>
    </section>
  )
  ...
  return (
    <section className="signal-section paper">
      ...
      <div className="signal-intro">
        <h2>A WEBSITE<br/>SHOULD <em>MOVE</em><br/>LIKE A MACHINE.</h2>
        <p>Layout remains readable DOM. Selected surfaces are upgraded into shader planes instead of trapping the whole experience inside one canvas.</p>
      </div>
...
function Mission() {
  return (
    <section className="mission-v2 dark" id="mission">
      <Suspense fallback={null}><PaperHeatField /></Suspense>
      ...
      <div className="mission-v2-inner">
        ...
        <div className="mission-map">
          <svg viewBox="0 0 1200 420" aria-label="Stylized route from Almaty to Depok" role="img">
            ...
            <path className="terrain b" d="M62 306 C218 194 337 248 450 304 S665 334 778 257 S986 205 1140 314" />
            <path className="route" d="M308 116 C514 26 738 58 902 282" />
            <circle cx="308" cy="116" r="7" /><circle cx="902" cy="282" r="7" />
            <text x="260" y="92">ALMATY</text><text x="922" y="300">DEPOK</text>
          </svg>
        </div>
        <div className="mission-facts">
          <article><span>02 / 15</span><b>QUALIFICATION RANK</b></article>
          <article><span>WINNER</span><b>THINK AWARD</b></article>
          <article><span>FINALIST</span><b>ALLIANCE CAPTAIN</b></article>
          <article><span>III</span><b>CONTROL AWARD</b></article>
        </div>
      </div>
    </section>
  )
...
function Engineering() {
  return (
    <section className="engineering-v2 dark" id="engineering">
      <Suspense fallback={null}><OglHeatField /></Suspense>
      <div className="engineering-v2-shade" />
      <div className="engineering-v2-inner">
        <SectionHead left="05 / ENGINEERING" right="MECHANICAL / CONTROL / SOFTWARE / ITERATION" />
        <div className="engineering-v2-intro">
          <h2>ANATOMY OF<br/><em>AN ITERATION.</em></h2>
          <p>No fake specifications are invented here. The interface is ready for the team's real competition CAD, while the current Spline Nexbot remains the presentation character.</p>
        </div>
        <EngineeringConsole />
      </div>
    </section>
...
function TeamSystem() {
  const items = [
    ['01', 'MECHANICAL', 'CAD, mechanisms, prototyping, fabrication and serviceability.'],
    ['02', 'SOFTWARE', 'Autonomous routines, controls, vision, telemetry and state logic.'],
    ['03', 'DESIGN', 'Identity, documentation, media and engineering communication.'],
    ['04', 'IMPACT', 'Outreach, workshops, partnerships and community visibility.'],
  ]
  return (
    <section className="team-v2 paper" id="team">
...
function Finale() {
  return (
    <section className="finale-v2 dark">
      <Suspense fallback={null}><PaperHeatField className="finale-paper-field" /></Suspense>
      <div className="finale-shade" />
      <div className="finale-v2-copy">
        <span>NEXT BUILD / ONLINE</span>
        <h2>ABAI<br/><em>BOL.</em></h2>
        <p>FORMERLY ANTARES · FTC ROBOTICS · ALMATY, KAZAKHSTAN</p>
        <div className="finale-actions">
          <Magnetic><a href="https://www.instagram.com/antares_ftc/" target="_blank" rel="noreferrer">INSTAGRAM ↗</a></Magnetic>
          <Magnetic><a href="https://ftc-events.firstinspires.org/" target="_blank" rel="noreferrer">FIRST ↗</a></Magnetic>
          <Magnetic><a href="#top">REPLAY ↑</a></Magnetic>
        </div>
      </div>
      <div className="finale-data"><span>ABAI BOL / 2026</span><span>BUILD / ITERATE / COMPETE</span></div>
    </section>
  )
}
...
export default function App() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.utils.toArray('.manifesto-title span').forEach((line, i) => {
        gsap.from(line, { yPercent: 110, opacity: 0, duration: 1.05, delay: i * .02, ease: 'power4.out', scrollTrigger: { trigger: line, start: 'top 88%' } })
      })
  ...
  return (
    <>
      ...
      <FilmGrain />
      <CursorFollower reduced={reduced} />
      <a className="skip-link" href="#main">SKIP TO CONTENT</a>
      <div className="global-progress"><i ref={progress} /></div>
      <main id="main">
        <FullscreenSpline reduced={reduced} />
        <Manifesto />
        <IdentityShift />
        <SignalSection />
        <Mission />
